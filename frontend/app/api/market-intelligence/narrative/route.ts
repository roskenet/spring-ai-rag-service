...
export async function POST(request: NextRequest) {
  try {
    ...
    const backendUrl = buildBackendUrl('/market-intelligence/narrative')
    ...
    if (!backendResponse.ok) {
      ...
      console.error(`Market Intelligence narrative backend error (${backendResponse.status}):`, errorText)
    ...
    console.error('Market Intelligence narrative proxy error:', error)
    return NextResponse.json(
